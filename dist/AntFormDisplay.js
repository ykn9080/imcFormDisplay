...
exports.default = exports.localHandle = exports.makeBtnArray = exports.shouldUpdateCheck = exports.createInitValuesWithDefault = exports.replaceListbyInitValues = exports.shouldConditionFilter = exports.labelShowhide = void 0;
...
const createInitValuesWithDefault = (list, changedInitVals) => {
  ...
  if (!param) param = {};
  localHandle("onFinish", _objectSpread(_objectSpread({}, param), newinitVal));
  return {
    name: newinitVal,
    label: newinitLabel,
    list
