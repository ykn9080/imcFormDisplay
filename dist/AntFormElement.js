...
var _IconButton = _interopRequireDefault(require("./config/IconButton"));
...
var _Sketch = _interopRequireDefault(require("./config/Sketch.js"));

var _LodashUtil = require("./config/LodashUtil");
...
const AntFormElement = props => {
  ...
  return !props.editable ? /*#__PURE__*/_react.default.createElement(_antd2.Col, {
    span: colnum
  }, /*#__PURE__*/_react.default.createElement(FormItem, props)) : null;
};
